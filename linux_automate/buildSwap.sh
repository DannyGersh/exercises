...
rm -r $PWD/production/volume/static/pages/login
...
cp -r $PWD/dev/login/build		$PWD/production/volume/static/pages/login
...
mv $PWD/production/volume/static/pages/login/index.html 	$PWD/production/volume/static/pages/login/login.html
